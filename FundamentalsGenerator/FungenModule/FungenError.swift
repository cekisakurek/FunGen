...
struct FunGenError {
    ...
    static func cannotCreateFile(name: String) -> NSError {
        return NSError(domain: "FunGen", code: -800, userInfo: [NSLocalizedDescriptionKey: "Cannot create file at path \(name)"])
    }
    ...
    static func cannotReadFile(name: String) -> NSError {
        return NSError(domain: "FunGen", code: -800, userInfo: [NSLocalizedDescriptionKey: "Cannot read file at path \(name)"])
    }
    
    static func cannotDecodeFile(name: String) -> NSError {
        return NSError(domain: "FunGen", code: -800, userInfo: [NSLocalizedDescriptionKey: "Cannot decode content at path \(name)"])
    }
    
    static func cannotRenderModule(name: String, filename: String) -> NSError {
        return NSError(domain: "FunGen", code: -800, userInfo: [NSLocalizedDescriptionKey: "Cannot render \(filename) for \(name)"])
    }
}
