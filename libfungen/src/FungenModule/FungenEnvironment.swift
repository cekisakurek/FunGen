...
public struct FungenEnvironment {
    ...
    var generateStateContent: (_ module: Module,_ dependencies: [Module],_ environment: FungenEnvironment, _ template: String) -> Effect<ModuleContent, NSError>
    
    var generateActionContent: (_ module: Module, _ dependencies: [Module], _ environment: FungenEnvironment, _ template: String) -> Effect<ModuleContent, NSError>
    
    var generateStateExtensionContent: (_ module: Module, _ dependencies: [Module], _ environment: FungenEnvironment, _ template: String) -> Effect<ModuleContent, NSError>
    ...
    var exitIfPossible: () -> Void
    
    
    public static let live = Self(mainQueue: DispatchQueue.main.eraseToAnyScheduler(),
